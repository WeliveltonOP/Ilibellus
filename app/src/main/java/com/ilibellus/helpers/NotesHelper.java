...
import com.ilibellus.helpers.count.CountFactory;
import com.ilibellus.models.Attachment;
import com.ilibellus.models.Note;
import com.ilibellus.models.StatsSingleNote;
    ...
    public static void addAttachments(boolean keepMergedNotes, Note note, ArrayList<Attachment> attachments) {
        if (keepMergedNotes) {
            for (Attachment attachment : note.getAttachmentsList()) {
                attachments.add(StorageHelper.createAttachmentFromUri(Ilibellus.getAppContext(), attachment.getUri
                        ()));
            }
        } else {
