...
import com.ilibellus.async.TextWorkerTask;
        ...
        if (!colorsPref.equals("disabled")) {
            ...
            if (note.getCategory() != null && note.getCategory().getColor() != null) {
                if (colorsPref.equals("complete") || colorsPref.equals("list")) {
                    ...
                    if (holder != null) {
                        holder.categoryMarker.setBackground(holder.categoryMarker.getContext().getDrawable(R.drawable.bg_category_marker));
                        holder.categoryMarker.getBackground().setColorFilter(Integer.parseInt(note.getCategory().getColor()), PorterDuff.Mode.DARKEN);
                    } else {
                        v.findViewById(R.id.category_marker).setBackground(v.getContext().getDrawable(R.drawable.bg_category_marker));
                        v.findViewById(R.id.category_marker).getBackground().setColorFilter(Integer.parseInt(note.getCategory().getColor()), PorterDuff.Mode.DARKEN);
                    }
                }
            } else {
