...
import com.ilibellus.async.upgrade.UpgradeProcessor;
...
import com.ilibellus.utils.AssetUtils;
...
public class DbHelper extends SQLiteOpenHelper {
	...
	public static synchronized DbHelper getInstance() {
		return getInstance(Ilibellus.getAppContext());
	}
	...
	public static synchronized DbHelper getInstance(boolean forcedNewInstance) {
		if (instance == null || forcedNewInstance) {
            Context context = instance.mContext == null ? Ilibellus.getAppContext() : instance.mContext;
			instance = new DbHelper(context);
		}
		return instance;
	}
