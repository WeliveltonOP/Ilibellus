...
public interface ConstantsBase {
	...
	String DATABASE_NAME = "ilibellus";
	String APP_STORAGE_DIRECTORY_SB_SYNC = "db_sync";

	String DEV_EMAIL = "woliveira2699@gmail.com";
	String GOOGLE_PLUS_COMMUNITY = "";
	String FACEBOOK_COMMUNITY = "";

	// Used for updates retrieval
	long UPDATE_MIN_FREQUENCY = 24L * 60L * 60L * 1000L; // 1 day
	String DRIVE_FOLDER_LAST_BUILD = "https://drive.google.com/drive/folders/1HwDjWCN8e-XtUguQTaTlbDFFUcXc2quS?usp=sharing";
