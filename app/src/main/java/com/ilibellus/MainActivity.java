...
import com.ilibellus.async.UpdateWidgetsTask;
...
import com.ilibellus.intro.IntroActivity;
...
public class MainActivity extends BaseActivity implements OnDateSetListener, OnTimeSetListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		setTheme(R.style.Theme_Ilibellus_ApiSpec);
...
//		new UpdaterTask(this).execute(); Removed due to missing backend
	...
	public void onEvent(PasswordRemovedEvent passwordRemovedEvent) {
		showMessage(R.string.password_successfully_removed, ONStyle.SUCCESS_COLOR);
		init();
	}
    ...
    public void showMessage(String message, int resTextColor) {
		...
		runOnUiThread(() -> Snackbar.make(findViewById(android.R.id.content), message, Snackbar.LENGTH_LONG)
                .setAction(null, null)
